(ns cloud-manager-api.api.variables
...
(defn-spec get-environment-variables-with-http-info any?
  ...
  (call-api "/api/program/{programId}/environment/{environmentId}/variables" :get
...
(defn-spec get-environment-variables variable-list-spec
  "List User Environment Variables
  List the user defined variables for an environment (Cloud Service only)."
  [programId string?, environmentId string?, x-gw-ims-org-id string?, Authorization string?, x-api-key string?]
  (let [res (:data (get-environment-variables-with-http-info programId environmentId x-gw-ims-org-id Authorization x-api-key))]
    (if (:decode-models *api-context*)
       (st/decode variable-list-spec res st/string-transformer)
       res)))


(defn-spec patch-environment-variables-with-http-info any?
  "Patch User Environment Variables
  Modify multiple environment variables (Cloud Service only). To delete a variable, include it with an empty value."
  [programId string?, environmentId string?, x-gw-ims-org-id string?, Authorization string?, x-api-key string?, Content-Type string?, body (s/coll-of variable-spec)]
  (check-required-params programId environmentId x-gw-ims-org-id Authorization x-api-key Content-Type body)
  (call-api "/api/program/{programId}/environment/{environmentId}/variables" :patch
            {:path-params   {"programId" programId "environmentId" environmentId }
...
(defn-spec patch-environment-variables variable-list-spec
  "Patch User Environment Variables
  Modify multiple environment variables (Cloud Service only). To delete a variable, include it with an empty value."
  [programId string?, environmentId string?, x-gw-ims-org-id string?, Authorization string?, x-api-key string?, Content-Type string?, body (s/coll-of variable-spec)]
  (let [res (:data (patch-environment-variables-with-http-info programId environmentId x-gw-ims-org-id Authorization x-api-key Content-Type body))]
    (if (:decode-models *api-context*)
       (st/decode variable-list-spec res st/string-transformer)
       res)))
