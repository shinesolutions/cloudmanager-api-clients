...
from pyaem_cloudmanager_api_client.models.pipeline_execution_list_representation import PipelineExecutionListRepresentation  # noqa: E501
from pyaem_cloudmanager_api_client.rest import ApiException

class TestPipelineExecutionListRepresentation(unittest.TestCase):
    """PipelineExecutionListRepresentation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = pyaem_cloudmanager_api_client.models.pipeline_execution_list_representation.PipelineExecutionListRepresentation()  # noqa: E501
        if include_optional :
            return PipelineExecutionListRepresentation(
                total_number_of_items = 56, 
                page = pyaem_cloudmanager_api_client.models.requested_page_details.RequestedPageDetails(
                    start = 56, 
                    limit = 56, 
                    order_by = '0', 
                    property = [
                    ...
                    next = 56, 
                    prev = 56, ), 
                embedded = pyaem_cloudmanager_api_client.models.pipeline_execution_list_representation__embedded.PipelineExecutionListRepresentation__embedded(
                    executions = [
                        pyaem_cloudmanager_api_client.models.pipeline_execution.pipelineExecution(
                            id = '0', 
                            program_id = '14', 
                            pipeline_id = '10', 
                            artifacts_version = '0', 
                            ...
                            _embedded = pyaem_cloudmanager_api_client.models.pipeline_execution__embedded.pipelineExecution__embedded(
                                step_states = [
                            ...
                            _links = pyaem_cloudmanager_api_client.models.pipeline_execution__links.pipelineExecution__links(), )
                        ], ), 
                links = pyaem_cloudmanager_api_client.models.pipeline_execution_list_representation__links.PipelineExecutionListRepresentation__links(
    ...
    def testPipelineExecutionListRepresentation(self):
        """Test PipelineExecutionListRepresentation"""
