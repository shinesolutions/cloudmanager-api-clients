...
from pyaem_cloudmanager_api_client.models.variable_list import VariableList  # noqa: E501
...
class TestVariableList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pyaem_cloudmanager_api_client.models.variable_list.VariableList()  # noqa: E501
        if include_optional :
            return VariableList(
                total_number_of_items = 1, 
                embedded = pyaem_cloudmanager_api_client.models.variable_list__embedded.variableList__embedded(
                    variables = [{ 'name':'variable1Name', 'value':'variable1Value'}, { 'name':'variable2Name', 'type':'secretString', 'value':'variable2SecretValue'}], ), 
                links = pyaem_cloudmanager_api_client.models.variable_list__links.variableList__links(
                    http://ns/adobe/com/adobecloud/rel/environment = pyaem_cloudmanager_api_client.models.hal_link.HalLink(
                        href = '0', 
                        templated = True, 
                        type = '0', 
                        deprecation = '0', 
