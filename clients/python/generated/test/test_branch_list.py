...
from pyaemcloudmanagerapi.models.branch_list import BranchList  # noqa: E501
...
class TestBranchList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pyaemcloudmanagerapi.models.branch_list.BranchList()  # noqa: E501
        if include_optional :
            return BranchList(
                total_number_of_items = 56, 
                embedded = pyaemcloudmanagerapi.models.branch_list__embedded.branchList__embedded(
                    branches = [
