...
from pyaem_cloudmanager_api_client.models.branch_list import BranchList  # noqa: E501
...
class TestBranchList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pyaem_cloudmanager_api_client.models.branch_list.BranchList()  # noqa: E501
        if include_optional :
            return BranchList(
                total_number_of_items = 56, 
                embedded = pyaem_cloudmanager_api_client.models.branch_list__embedded.branchList__embedded(
                    branches = [
