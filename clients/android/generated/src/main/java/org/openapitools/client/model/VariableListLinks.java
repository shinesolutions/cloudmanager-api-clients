...
public class VariableListLinks {
  ...
  @SerializedName("http://ns.adobe.com/adobecloud/rel/environment")
  ...
  public boolean equals(Object o) {
    ...
    return (this.httpNsAdobeComAdobecloudRelEnvironment == null ? variableListLinks.httpNsAdobeComAdobecloudRelEnvironment == null : this.httpNsAdobeComAdobecloudRelEnvironment.equals(variableListLinks.httpNsAdobeComAdobecloudRelEnvironment)) &&
        (this.httpNsAdobeComAdobecloudRelProgram == null ? variableListLinks.httpNsAdobeComAdobecloudRelProgram == null : this.httpNsAdobeComAdobecloudRelProgram.equals(variableListLinks.httpNsAdobeComAdobecloudRelProgram)) &&
        (this.self == null ? variableListLinks.self == null : this.self.equals(variableListLinks.self));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.httpNsAdobeComAdobecloudRelEnvironment == null ? 0: this.httpNsAdobeComAdobecloudRelEnvironment.hashCode());
