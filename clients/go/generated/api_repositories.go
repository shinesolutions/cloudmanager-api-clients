...
*/
func (a *RepositoriesApiService) GetRepositories(ctx _context.Context, programId string, xGwImsOrgId string, authorization string, xApiKey string) (RepositoryList, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/program/{programId}/repositories"
...
@return Repository
*/
func (a *RepositoriesApiService) GetRepository(ctx _context.Context, programId string, repositoryId string, xGwImsOrgId string, authorization string, xApiKey string) (Repository, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/program/{programId}/repository/{repositoryId}"
	localVarPath = strings.Replace(localVarPath, "{"+"programId"+"}", _neturl.QueryEscape(parameterToString(programId, "")) , -1)
