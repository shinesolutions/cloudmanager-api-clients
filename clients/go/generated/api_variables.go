...
@return VariableList
*/
func (a *VariablesApiService) GetEnvironmentVariables(ctx _context.Context, programId string, environmentId string, xGwImsOrgId string, authorization string, xApiKey string) (VariableList, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/program/{programId}/environment/{environmentId}/variables"
...
@return VariableList
*/
func (a *VariablesApiService) PatchEnvironmentVariables(ctx _context.Context, programId string, environmentId string, xGwImsOrgId string, authorization string, xApiKey string, contentType string, body []Variable) (VariableList, *_nethttp.Response, error) {
	var (
