...
pub struct VariableListLinks {
    #[serde(rename = "http://ns.adobe.com/adobecloud/rel/environment", skip_serializing_if = "Option::is_none")]
    pub http__ns_adobe_com_adobecloud_rel_environment: Option<crate::models::HalLink>,
