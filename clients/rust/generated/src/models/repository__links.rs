...
pub struct RepositoryLinks {
    ...
    #[serde(rename = "http://ns.adobe.com/adobecloud/rel/branches", skip_serializing_if = "Option::is_none")]
    pub http__ns_adobe_com_adobecloud_rel_branches: Option<crate::models::HalLink>,
