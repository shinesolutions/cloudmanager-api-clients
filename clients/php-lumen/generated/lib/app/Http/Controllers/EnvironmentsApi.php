...
class EnvironmentsApi extends Controller
{
    /**
     * Constructor
     */
     ...
     */
    public function deleteEnvironment($program_id, $environment_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function getEnvironment($program_id, $environment_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function getEnvironmentLogs($program_id, $environment_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function downloadLogs($program_id, $environment_id)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function getEnvironments($program_id)
    {
        $input = Request::all();
