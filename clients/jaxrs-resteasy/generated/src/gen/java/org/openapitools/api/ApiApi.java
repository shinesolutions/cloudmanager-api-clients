...
public class ApiApi  {
    ...
    throws NotFoundException {
        return service.advancePipelineExecution(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,contentType,body,securityContext);
    }
    @PUT
    ...
    throws NotFoundException {
        return service.cancelPipelineExecutionStep(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,contentType,body,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deleteEnvironment(programId,environmentId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deletePipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deleteProgram(programId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.downloadLogs(programId,environmentId,service,name,date,xGwImsOrgId,authorization,xApiKey,accept,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getBranches(programId,repositoryId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getCurrentExecution(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    @Path("/program/{programId}/environment/{environmentId}")
    ...
    throws NotFoundException {
        return service.getEnvironment(programId,environmentId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getEnvironmentLogs(programId,environmentId,days,xGwImsOrgId,authorization,xApiKey,service,name,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getEnvironmentVariables(programId,environmentId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getEnvironments(programId,xGwImsOrgId,authorization,xApiKey,type,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getExecution(programId,pipelineId,executionId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getExecutions(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,start,limit,securityContext);
    }
    @GET
    @Path("/program/{programId}/pipeline/{pipelineId}")
    ...
    throws NotFoundException {
        return service.getPipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getPipelines(programId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    @Path("/program/{programId}")
    ...
    throws NotFoundException {
        return service.getProgram(programId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    @Path("/programs")
    ...
    throws NotFoundException {
        return service.getPrograms(xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getRepositories(programId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getRepository(programId,repositoryId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getStepLogs(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,file,accept,securityContext);
    }
    @PATCH
    @Path("/program/{programId}/environment/{environmentId}/variables")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.patchEnvironmentVariables(programId,environmentId,xGwImsOrgId,authorization,xApiKey,contentType,body,securityContext);
    }
    @PATCH
    @Path("/program/{programId}/pipeline/{pipelineId}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.patchPipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,contentType,body,securityContext);
    }
    @PUT
    @Path("/program/{programId}/pipeline/{pipelineId}/execution")
    ...
    throws NotFoundException {
        return service.startPipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,contentType,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.stepMetric(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.stepState(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,securityContext);
    }
}
