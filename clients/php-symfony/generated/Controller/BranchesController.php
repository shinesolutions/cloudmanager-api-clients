...
/**
 * BranchesController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class BranchesController extends Controller
{
     ...
     */
    public function getBranchesAction(Request $request, $programId, $repositoryId)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->getBranches($programId, $repositoryId, $xGwImsOrgId, $authorization, $xApiKey, $responseCode, $responseHeaders);
     ...
     * @return BranchesApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('branches');
    }
}
