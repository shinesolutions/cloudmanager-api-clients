...
/**
 * Class representing the Program model.
 *
...
class Program 
{
    ...
    /**
     * @var OpenAPI\Server\Model\ProgramLinks|null
     * @SerializedName("_links")
     * @Assert\Type("OpenAPI\Server\Model\ProgramLinks")
     * @Type("OpenAPI\Server\Model\ProgramLinks")
     */
    protected $links;
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->imsOrgId = isset($data['imsOrgId']) ? $data['imsOrgId'] : null;
     ...
     * Sets imsOrgId.
     *
     * @param string|null $imsOrgId  Organisation Id
     *
     * @return $this
     */
    public function setImsOrgId($imsOrgId = null)
    {
     ...
     * Gets links.
     *
     * @return OpenAPI\Server\Model\ProgramLinks|null
     */
    public function getLinks(): ?ProgramLinks
    {
        return $this->links;
    }
     ...
     * Sets links.
     *
     * @param OpenAPI\Server\Model\ProgramLinks|null $links
     *
     * @return $this
     */
    public function setLinks(ProgramLinks $links = null): ?ProgramLinks
    {
        $this->links = $links;
