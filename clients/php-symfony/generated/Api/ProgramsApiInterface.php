...
/**
 * ProgramsApiInterface Interface Doc Comment
 *
 * @category Interface
...
interface ProgramsApiInterface
{
     ...
     *
     */
    public function deleteProgram($programId, $xGwImsOrgId, $authorization, $xApiKey, &$responseCode, array &$responseHeaders);
     ...
     *
     */
    public function getProgram($programId, $xGwImsOrgId, $authorization, $xApiKey, &$responseCode, array &$responseHeaders);
     ...
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return OpenAPI\Server\Model\ProgramList
     *
     */
    public function getPrograms($xGwImsOrgId, $authorization, $xApiKey, &$responseCode, array &$responseHeaders);
}
