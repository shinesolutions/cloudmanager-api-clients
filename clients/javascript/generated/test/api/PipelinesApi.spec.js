...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.PipelinesApi();
  });
  ...
  describe('PipelinesApi', function() {
    ...
    describe('patchPipeline', function() {
      it('should call patchPipeline successfully', function(done) {
        //uncomment below and update the code to test patchPipeline
        //instance.patchPipeline(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
