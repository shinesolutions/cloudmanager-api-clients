...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.EnvironmentsApi();
  });
  ...
  describe('EnvironmentsApi', function() {
    ...
    describe('downloadLogs', function() {
      it('should call downloadLogs successfully', function(done) {
        //uncomment below and update the code to test downloadLogs
        //instance.downloadLogs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEnvironmentLogs', function() {
      it('should call getEnvironmentLogs successfully', function(done) {
        //uncomment below and update the code to test getEnvironmentLogs
        //instance.getEnvironmentLogs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
