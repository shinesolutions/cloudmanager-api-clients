...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.ProgramList();
  });
  ...
  describe('ProgramList', function() {
    it('should create an instance of ProgramList', function() {
      ...
      //var instane = new NodeAemCloudmanagerApiClient.ProgramList();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.ProgramList);
    });
