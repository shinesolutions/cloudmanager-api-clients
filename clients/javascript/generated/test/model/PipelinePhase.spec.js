...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.PipelinePhase();
  });
  ...
  describe('PipelinePhase', function() {
    it('should create an instance of PipelinePhase', function() {
      // uncomment below and update the code to test PipelinePhase
      //var instane = new NodeAemCloudmanagerApiClient.PipelinePhase();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.PipelinePhase);
    });
