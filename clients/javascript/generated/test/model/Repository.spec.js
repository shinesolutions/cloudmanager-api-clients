...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.Repository();
  });
  ...
  describe('Repository', function() {
    it('should create an instance of Repository', function() {
      ...
      //var instane = new NodeAemCloudmanagerApiClient.Repository();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.Repository);
    });
