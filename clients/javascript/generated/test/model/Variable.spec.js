...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.Variable();
  });
  ...
  describe('Variable', function() {
    it('should create an instance of Variable', function() {
      ...
      //var instane = new NodeAemCloudmanagerApiClient.Variable();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.Variable);
    });
