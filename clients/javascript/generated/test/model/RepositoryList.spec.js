...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.RepositoryList();
  });
  ...
  describe('RepositoryList', function() {
    it('should create an instance of RepositoryList', function() {
      // uncomment below and update the code to test RepositoryList
      //var instane = new NodeAemCloudmanagerApiClient.RepositoryList();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.RepositoryList);
    });
