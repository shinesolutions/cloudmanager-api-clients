...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.EnvironmentLogs();
  });
  ...
  describe('EnvironmentLogs', function() {
    it('should create an instance of EnvironmentLogs', function() {
      // uncomment below and update the code to test EnvironmentLogs
      //var instane = new NodeAemCloudmanagerApiClient.EnvironmentLogs();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.EnvironmentLogs);
    });
