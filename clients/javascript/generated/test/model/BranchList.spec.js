...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.BranchList();
  });
  ...
  describe('BranchList', function() {
    it('should create an instance of BranchList', function() {
      // uncomment below and update the code to test BranchList
      //var instane = new NodeAemCloudmanagerApiClient.BranchList();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.BranchList);
    });
