...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.EnvironmentList();
  });
  ...
  describe('EnvironmentList', function() {
    it('should create an instance of EnvironmentList', function() {
      // uncomment below and update the code to test EnvironmentList
      //var instane = new NodeAemCloudmanagerApiClient.EnvironmentList();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.EnvironmentList);
    });
