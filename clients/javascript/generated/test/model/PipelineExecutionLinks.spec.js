...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.PipelineExecutionLinks();
  });
  ...
  describe('PipelineExecutionLinks', function() {
    it('should create an instance of PipelineExecutionLinks', function() {
      // uncomment below and update the code to test PipelineExecutionLinks
      //var instane = new NodeAemCloudmanagerApiClient.PipelineExecutionLinks();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.PipelineExecutionLinks);
    });
