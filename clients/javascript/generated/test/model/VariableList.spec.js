...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeAemCloudmanagerApiClient.VariableList();
  });
  ...
  describe('VariableList', function() {
    it('should create an instance of VariableList', function() {
      ...
      //var instane = new NodeAemCloudmanagerApiClient.VariableList();
      //expect(instance).to.be.a(NodeAemCloudmanagerApiClient.VariableList);
    });
