...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PipelineExecutionStepStateLinks :  IEquatable<PipelineExecutionStepStateLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PipelineExecutionStepStateLinks" /> class.
        /// </summary>
        ...
        /// <param name="httpNsAdobeComAdobecloudRelPipelineLogs">httpNsAdobeComAdobecloudRelPipelineLogs.</param>
        /// <param name="httpNsAdobeComAdobecloudRelPipelineMetrics">httpNsAdobeComAdobecloudRelPipelineMetrics.</param>
        /// <param name="httpNsAdobeComAdobecloudRelPipelineAdvance">httpNsAdobeComAdobecloudRelPipelineAdvance.</param>
        /// <param name="httpNsAdobeComAdobecloudRelPipelineCancel">httpNsAdobeComAdobecloudRelPipelineCancel.</param>
        /// <param name="httpNsAdobeComAdobecloudRelProgram">httpNsAdobeComAdobecloudRelProgram.</param>
        /// <param name="self">self.</param>
        public PipelineExecutionStepStateLinks(HalLink httpNsAdobeComAdobecloudRelExecution = default(HalLink), HalLink httpNsAdobeComAdobecloudRelPipeline = default(HalLink), HalLink httpNsAdobeComAdobecloudRelPipelineLogs = default(HalLink), HalLink httpNsAdobeComAdobecloudRelPipelineMetrics = default(HalLink), HalLink httpNsAdobeComAdobecloudRelPipelineAdvance = default(HalLink), HalLink httpNsAdobeComAdobecloudRelPipelineCancel = default(HalLink), HalLink httpNsAdobeComAdobecloudRelProgram = default(HalLink), HalLink self = default(HalLink))
        {
        ...
        {
            return this.Equals(input as PipelineExecutionStepStateLinks);
        }

        /// <summary>
        /// Returns true if PipelineExecutionStepStateLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of PipelineExecutionStepStateLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PipelineExecutionStepStateLinks input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HttpNsAdobeComAdobecloudRelPipelineLogs == input.HttpNsAdobeComAdobecloudRelPipelineLogs ||
                    (this.HttpNsAdobeComAdobecloudRelPipelineLogs != null &&
                    this.HttpNsAdobeComAdobecloudRelPipelineLogs.Equals(input.HttpNsAdobeComAdobecloudRelPipelineLogs))
                ) && 
                (
                    this.HttpNsAdobeComAdobecloudRelPipelineMetrics == input.HttpNsAdobeComAdobecloudRelPipelineMetrics ||
                    (this.HttpNsAdobeComAdobecloudRelPipelineMetrics != null &&
                    this.HttpNsAdobeComAdobecloudRelPipelineMetrics.Equals(input.HttpNsAdobeComAdobecloudRelPipelineMetrics))
                ) && 
                (
                    this.HttpNsAdobeComAdobecloudRelPipelineAdvance == input.HttpNsAdobeComAdobecloudRelPipelineAdvance ||
                    (this.HttpNsAdobeComAdobecloudRelPipelineAdvance != null &&
                    this.HttpNsAdobeComAdobecloudRelPipelineAdvance.Equals(input.HttpNsAdobeComAdobecloudRelPipelineAdvance))
                ) && 
                (
                    this.HttpNsAdobeComAdobecloudRelPipelineCancel == input.HttpNsAdobeComAdobecloudRelPipelineCancel ||
                    (this.HttpNsAdobeComAdobecloudRelPipelineCancel != null &&
                    this.HttpNsAdobeComAdobecloudRelPipelineCancel.Equals(input.HttpNsAdobeComAdobecloudRelPipelineCancel))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpNsAdobeComAdobecloudRelPipelineLogs != null)
                    hashCode = hashCode * 59 + this.HttpNsAdobeComAdobecloudRelPipelineLogs.GetHashCode();
                if (this.HttpNsAdobeComAdobecloudRelPipelineMetrics != null)
                    hashCode = hashCode * 59 + this.HttpNsAdobeComAdobecloudRelPipelineMetrics.GetHashCode();
                if (this.HttpNsAdobeComAdobecloudRelPipelineAdvance != null)
                    hashCode = hashCode * 59 + this.HttpNsAdobeComAdobecloudRelPipelineAdvance.GetHashCode();
                if (this.HttpNsAdobeComAdobecloudRelPipelineCancel != null)
                    hashCode = hashCode * 59 + this.HttpNsAdobeComAdobecloudRelPipelineCancel.GetHashCode();
