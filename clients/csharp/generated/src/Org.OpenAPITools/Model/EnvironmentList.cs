...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvironmentList :  IEquatable<EnvironmentList>, IValidatableObject
    {
        /// <summary>
        ...
        public EnvironmentList(int totalNumberOfItems = default(int), EnvironmentListEmbedded embedded = default(EnvironmentListEmbedded), ProgramListLinks links = default(ProgramListLinks))
        {
        ...
        {
            return this.Equals(input as EnvironmentList);
        }

        /// <summary>
        /// Returns true if EnvironmentList instances are equal
        /// </summary>
        /// <param name="input">Instance of EnvironmentList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvironmentList input)
        {
            if (input == null)
                return false;
