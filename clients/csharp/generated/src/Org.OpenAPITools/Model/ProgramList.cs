...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProgramList :  IEquatable<ProgramList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgramList" /> class.
        /// </summary>
        /// <param name="totalNumberOfItems">totalNumberOfItems.</param>
        /// <param name="embedded">embedded.</param>
        /// <param name="links">links.</param>
        public ProgramList(int totalNumberOfItems = default(int), ProgramListEmbedded embedded = default(ProgramListEmbedded), ProgramListLinks links = default(ProgramListLinks))
        {
        ...
        {
            return this.Equals(input as ProgramList);
        }

        /// <summary>
        /// Returns true if ProgramList instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgramList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgramList input)
        {
            if (input == null)
                return false;
