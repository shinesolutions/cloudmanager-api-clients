...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RepositoryList :  IEquatable<RepositoryList>, IValidatableObject
    {
        ...
        public RepositoryList(int totalNumberOfItems = default(int), RepositoryListEmbedded embedded = default(RepositoryListEmbedded), ProgramListLinks links = default(ProgramListLinks))
        {
