...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProgramListLinks :  IEquatable<ProgramListLinks>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProgramListLinks);
        }

        /// <summary>
        /// Returns true if ProgramListLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgramListLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgramListLinks input)
        {
            if (input == null)
                return false;
