...
export class ProgramsApi {
     ...
     */
    public deleteProgram (programId: string, xGwImsOrgId: string, authorization: string, xApiKey: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Program> {
     ...
     * @param xApiKey IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io
     */
    public getProgram (programId: string, xGwImsOrgId: string, authorization: string, xApiKey: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.Program> {
        const localVarPath = this.basePath + '/api/program/{programId}'
            .replace('{' + 'programId' + '}', encodeURIComponent(String(programId)));
     ...
     * @param xApiKey IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io
     */
    public getPrograms (xGwImsOrgId: string, authorization: string, xApiKey: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ProgramList> {
