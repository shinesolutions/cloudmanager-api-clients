...
@Autowired
    public BranchesApiController(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    public ResponseEntity<BranchList> getBranches(@ApiParam(value = "Identifier of the program.",required=true ) @PathVariable("programId") String programId,
        ...
        if (accept != null && accept.contains("application/json")) {
            return new ResponseEntity<BranchList>(objectMapper.readValue("", BranchList.class), HttpStatus.OK);
        }
