...
# @param string $x_api_key IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_environment_variables' } = { 
...
sub get_environment_variables {
    ...
    unless (exists $args{'program_id'}) {
      croak("Missing the required parameter 'program_id' when calling get_environment_variables");
    }

    # verify the required parameter 'environment_id' is set
    unless (exists $args{'environment_id'}) {
      croak("Missing the required parameter 'environment_id' when calling get_environment_variables");
    }

    # verify the required parameter 'x_gw_ims_org_id' is set
    unless (exists $args{'x_gw_ims_org_id'}) {
      croak("Missing the required parameter 'x_gw_ims_org_id' when calling get_environment_variables");
    }

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling get_environment_variables");
    }

    # verify the required parameter 'x_api_key' is set
    unless (exists $args{'x_api_key'}) {
      croak("Missing the required parameter 'x_api_key' when calling get_environment_variables");
    }

    # parse inputs
    my $_resource_path = '/api/program/{programId}/environment/{environmentId}/variables';
...
# @param ARRAY[Variable] $body The list of variables to add, modify, or remove. It is not necessary to send variables here which are not changing. (required)
{
    my $params = {
    'program_id' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'patch_environment_variables' } = { 
...
# @return VariableList
#
sub patch_environment_variables {
    my ($self, %args) = @_;

    # verify the required parameter 'program_id' is set
    unless (exists $args{'program_id'}) {
      croak("Missing the required parameter 'program_id' when calling patch_environment_variables");
    }

    # verify the required parameter 'environment_id' is set
    unless (exists $args{'environment_id'}) {
      croak("Missing the required parameter 'environment_id' when calling patch_environment_variables");
    }

    # verify the required parameter 'x_gw_ims_org_id' is set
    unless (exists $args{'x_gw_ims_org_id'}) {
      croak("Missing the required parameter 'x_gw_ims_org_id' when calling patch_environment_variables");
    }

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling patch_environment_variables");
    }

    # verify the required parameter 'x_api_key' is set
    unless (exists $args{'x_api_key'}) {
      croak("Missing the required parameter 'x_api_key' when calling patch_environment_variables");
    }

    # verify the required parameter 'content_type' is set
    unless (exists $args{'content_type'}) {
      croak("Missing the required parameter 'content_type' when calling patch_environment_variables");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_environment_variables");
    }
