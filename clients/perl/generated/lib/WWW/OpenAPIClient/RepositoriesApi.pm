...
#
package WWW::OpenAPIClient::RepositoriesApi;
...
# @param string $x_api_key IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_repositories' } = { 
...
sub get_repositories {
    ...
    unless (exists $args{'program_id'}) {
      croak("Missing the required parameter 'program_id' when calling get_repositories");
    }

    # verify the required parameter 'x_gw_ims_org_id' is set
    unless (exists $args{'x_gw_ims_org_id'}) {
      croak("Missing the required parameter 'x_gw_ims_org_id' when calling get_repositories");
    }

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling get_repositories");
    }

    # verify the required parameter 'x_api_key' is set
    unless (exists $args{'x_api_key'}) {
      croak("Missing the required parameter 'x_api_key' when calling get_repositories");
    }

    # parse inputs
    my $_resource_path = '/api/program/{programId}/repositories';
    ...
    my $_response_object = $self->{api_client}->deserialize('RepositoryList', $response);
...
# @param string $x_api_key IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_repository' } = { 
...
sub get_repository {
    ...
    # verify the required parameter 'program_id' is set
    unless (exists $args{'program_id'}) {
      croak("Missing the required parameter 'program_id' when calling get_repository");
    }

    # verify the required parameter 'repository_id' is set
    unless (exists $args{'repository_id'}) {
      croak("Missing the required parameter 'repository_id' when calling get_repository");
    }

    # verify the required parameter 'x_gw_ims_org_id' is set
    unless (exists $args{'x_gw_ims_org_id'}) {
      croak("Missing the required parameter 'x_gw_ims_org_id' when calling get_repository");
    }

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling get_repository");
    }

    # verify the required parameter 'x_api_key' is set
    unless (exists $args{'x_api_key'}) {
      croak("Missing the required parameter 'x_api_key' when calling get_repository");
    }

    # parse inputs
    my $_resource_path = '/api/program/{programId}/repository/{repositoryId}';
    ...
    # path params
    if ( exists $args{'repository_id'}) {
        my $_base_variable = "{" . "repositoryId" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'repository_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('Repository', $response);
    return $_response_object;
}
