...
#
package WWW::OpenAPIClient::Object::PipelineExecutionStepState;
...
__PACKAGE__->class_documentation({description => 'Describes the status of a particular pipeline execution step for display purposes',
...
__PACKAGE__->method_documentation({
    ...
    '_links' => {
        datatype => 'PipelineExecutionStepStateLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => '',
