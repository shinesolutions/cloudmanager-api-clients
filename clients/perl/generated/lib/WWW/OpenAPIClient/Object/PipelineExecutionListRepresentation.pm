...
#
package WWW::OpenAPIClient::Object::PipelineExecutionListRepresentation;
...
__PACKAGE__->class_documentation({description => 'List of pipeline executions',
                                  class => 'PipelineExecutionListRepresentation',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    '_total_number_of_items' => {
        datatype => 'int',
        base_name => '_totalNumberOfItems',
        description => '',
        format => '',
        read_only => '',
            },
    '_page' => {
        datatype => 'RequestedPageDetails',
        base_name => '_page',
        description => '',
        format => '',
        read_only => '',
    ...
    '_embedded' => {
        datatype => 'PipelineExecutionListRepresentationEmbedded',
        base_name => '_embedded',
        description => '',
        format => '',
        read_only => '',
    ...
    '_links' => {
        datatype => 'PipelineExecutionListRepresentationLinks',
        base_name => '_links',
        description => '',
        format => '',
        read_only => '',
