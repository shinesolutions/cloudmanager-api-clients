...
__PACKAGE__->class_documentation({description => 'Describes a __CI/CD Pipeline__',
                                  class => 'Pipeline',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'last_finished_at' => {
        datatype => 'DateTime',
        base_name => 'lastFinishedAt',
        description => 'Last pipeline execution end',
        format => '',
        read_only => '',
            },
    'phases' => {
        datatype => 'ARRAY[PipelinePhase]',
        base_name => 'phases',
