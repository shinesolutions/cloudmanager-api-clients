...
#
package WWW::OpenAPIClient::BranchesApi;
...
# @param string $x_api_key IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_branches' } = { 
...
sub get_branches {
    ...
    unless (exists $args{'program_id'}) {
      croak("Missing the required parameter 'program_id' when calling get_branches");
    }

    # verify the required parameter 'repository_id' is set
    unless (exists $args{'repository_id'}) {
      croak("Missing the required parameter 'repository_id' when calling get_branches");
    }

    # verify the required parameter 'x_gw_ims_org_id' is set
    unless (exists $args{'x_gw_ims_org_id'}) {
      croak("Missing the required parameter 'x_gw_ims_org_id' when calling get_branches");
    }

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling get_branches");
    }

    # verify the required parameter 'x_api_key' is set
    unless (exists $args{'x_api_key'}) {
      croak("Missing the required parameter 'x_api_key' when calling get_branches");
    }

    # parse inputs
    my $_resource_path = '/api/program/{programId}/repository/{repositoryId}/branches';
    ...
    my $_response_object = $self->{api_client}->deserialize('BranchList', $response);
