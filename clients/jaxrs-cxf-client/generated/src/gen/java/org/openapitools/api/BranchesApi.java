...
public interface BranchesApi  {
    ...
    @ApiOperation(value = "List Branches", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful retrieval of the list of repository branches", response = BranchList.class) })
    public BranchList getBranches(@PathParam("programId") String programId, @PathParam("repositoryId") String repositoryId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey);
}
