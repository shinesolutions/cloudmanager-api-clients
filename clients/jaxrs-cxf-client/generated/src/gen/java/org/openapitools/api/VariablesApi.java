...
public interface VariablesApi  {
    ...
    @ApiOperation(value = "List User Environment Variables", tags={  })
    @ApiResponses(value = { 
    ...
    public VariableList getEnvironmentVariables(@PathParam("programId") String programId, @PathParam("environmentId") String environmentId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Patch User Environment Variables", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful update of environment variables", response = VariableList.class),
        @ApiResponse(code = 404, message = "Environment not found") })
    public VariableList patchEnvironmentVariables(@PathParam("programId") String programId, @PathParam("environmentId") String environmentId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey, @HeaderParam("Content-Type")  String contentType, List<Variable> body);
}
