...
public interface PipelineExecutionApi  {
    ...
    @ApiOperation(value = "Advance", tags={  })
    @ApiResponses(value = { 
    ...
    public void advancePipelineExecution(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @PathParam("executionId") String executionId, @PathParam("phaseId") String phaseId, @PathParam("stepId") String stepId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey, @HeaderParam("Content-Type")  String contentType, Object body);
    ...
    @Consumes({ "application/json" })
    @ApiOperation(value = "Cancel", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "No pipeline execution exits or unknown pipeline or program") })
    public void cancelPipelineExecutionStep(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @PathParam("executionId") String executionId, @PathParam("phaseId") String phaseId, @PathParam("stepId") String stepId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey, @HeaderParam("Content-Type")  String contentType, Object body);
    ...
    @ApiOperation(value = "Get current pipeline execution", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful retrieval of current execution", response = PipelineExecution.class),
        @ApiResponse(code = 404, message = "No pipeline execution exits or unknown pipeline or program") })
    public PipelineExecution getCurrentExecution(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get pipeline execution", tags={  })
    @ApiResponses(value = { 
    ...
    public PipelineExecution getExecution(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @PathParam("executionId") String executionId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List Executions", tags={  })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get logs", tags={  })
    @ApiResponses(value = { 
    ...
    public void getStepLogs(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @PathParam("executionId") String executionId, @PathParam("phaseId") String phaseId, @PathParam("stepId") String stepId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey, @QueryParam("file") String file, @HeaderParam("Accept")  String accept);
    ...
    @PUT
    @Path("/api/program/{programId}/pipeline/{pipelineId}/execution")
    @ApiOperation(value = "Start the pipeline", tags={  })
    @ApiResponses(value = { 
    ...
    public void startPipeline(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey, @HeaderParam("Content-Type")  String contentType);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get step metrics", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Pipeline execution does not exist") })
    public PipelineStepMetrics stepMetric(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @PathParam("executionId") String executionId, @PathParam("phaseId") String phaseId, @PathParam("stepId") String stepId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get step state", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Pipeline execution does not exist") })
    public PipelineExecutionStepState stepState(@PathParam("programId") String programId, @PathParam("pipelineId") String pipelineId, @PathParam("executionId") String executionId, @PathParam("phaseId") String phaseId, @PathParam("stepId") String stepId, @HeaderParam("x-gw-ims-org-id")  String xGwImsOrgId, @HeaderParam("Authorization")  String authorization, @HeaderParam("x-api-key")  String xApiKey);
}
