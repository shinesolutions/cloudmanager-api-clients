...
defmodule CloudManagerAPI.Model.VariableListLinks do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"http://ns.adobe.com/adobecloud/rel/environment" => HalLink | nil,
    :"http://ns.adobe.com/adobecloud/rel/program" => HalLink | nil,
    :"self" => HalLink | nil
  }
end

defimpl Poison.Decoder, for: CloudManagerAPI.Model.VariableListLinks do
  import CloudManagerAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"http://ns.adobe.com/adobecloud/rel/environment", :struct, CloudManagerAPI.Model.HalLink, options)
