...
use OpenAPIServer\Model\PipelineExecution;

/**
 * PipelineExecutionTest Class Doc Comment
 *
 * @package OpenAPIServer\Model
 * @author  OpenAPI Generator team
 * @link    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \OpenAPIServer\Model\PipelineExecution
 */
class PipelineExecutionTest extends TestCase
{
    ...
    {
        $testPipelineExecution = new PipelineExecution();
    }
    ...
    /**
     * Test attribute "artifactsVersion"
     */
    public function testPropertyArtifactsVersion()
    {
    }
    ...
    {
        $schemaObject = PipelineExecution::getOpenApiSchema();
        $schemaArr = PipelineExecution::getOpenApiSchema(true);
