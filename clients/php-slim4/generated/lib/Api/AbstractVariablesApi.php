...
/**
 * AbstractVariablesApi Class Doc Comment
 *
 * @package OpenAPIServer\Api
 * @author  OpenAPI Generator team
 * @link    https://github.com/openapitools/openapi-generator
 */
abstract class AbstractVariablesApi
{
     ...
     */
    public function getEnvironmentVariables(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        ...
        $message = "How about implementing getEnvironmentVariables as a GET method in OpenAPIServer\Api\VariablesApi class?";
     ...
     * @throws Exception to force implementation class to override this method
     */
    public function patchEnvironmentVariables(ServerRequestInterface $request, ResponseInterface $response, array $args)
    {
        $headers = $request->getHeaders();
        $xGwImsOrgId = $request->hasHeader('x-gw-ims-org-id') ? $headers['x-gw-ims-org-id'] : null;
        $authorization = $request->hasHeader('Authorization') ? $headers['Authorization'] : null;
        ...
        $message = "How about implementing patchEnvironmentVariables as a PATCH method in OpenAPIServer\Api\VariablesApi class?";
        throw new Exception($message);
