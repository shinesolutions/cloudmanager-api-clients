...
public class ApiApi  {
   private final ApiApiService delegate = ApiApiServiceFactory.getApiApi();
    ...
    public Response advancePipelineExecution(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "Identifier of the execution",required=true) @PathParam("executionId") String executionId
,@ApiParam(value = "Identifier of the phase",required=true) @PathParam("phaseId") String phaseId
,@ApiParam(value = "Identifier of the step",required=true) @PathParam("stepId") String stepId
...
,@ApiParam(value = "Input for advance. See documentation for details." ,required=true) Object body
)
    throws NotFoundException {
        return delegate.advancePipelineExecution(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,contentType,body);
    }
    @PUT
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "No pipeline execution exits or unknown pipeline or program", response = Void.class) })
    public Response cancelPipelineExecutionStep(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "Identifier of the execution",required=true) @PathParam("executionId") String executionId
,@ApiParam(value = "Identifier of the phase",required=true) @PathParam("phaseId") String phaseId
,@ApiParam(value = "Identifier of the step",required=true) @PathParam("stepId") String stepId
...
,@ApiParam(value = "Input for advance. See documentation for details." ,required=true) Object body
    ...
    throws NotFoundException {
        return delegate.cancelPipelineExecutionStep(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,contentType,body);
    }
    @DELETE
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Environment deletion in progress", response = Environment.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Environment not found", response = Environment.class) })
    public Response deleteEnvironment(@ApiParam(value = "Identifier of the application",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the environment",required=true) @PathParam("environmentId") String environmentId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
)
    throws NotFoundException {
        return delegate.deleteEnvironment(programId,environmentId,xGwImsOrgId,authorization,xApiKey);
    }
    @DELETE
    ...
    public Response deletePipeline(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.deletePipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey);
    }
    @DELETE
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 403, message = "Forbidden.", response = Program.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Program not found.", response = Program.class),
        
        @io.swagger.annotations.ApiResponse(code = 412, message = "Deletion not supported", response = Program.class) })
    public Response deleteProgram(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
)
    throws NotFoundException {
        return delegate.deleteProgram(programId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    public Response downloadLogs(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the environment",required=true) @PathParam("environmentId") String environmentId
,@ApiParam(value = "Name of service",required=true) @QueryParam("service") String service
,@ApiParam(value = "Name of log",required=true) @QueryParam("name") String name
,@ApiParam(value = "date for which log is required",required=true) @QueryParam("date") String date
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
,@ApiParam(value = "Specify application/json in this header to receive a JSON response. Otherwise, a 307 response code will be returned with a Location header." )@HeaderParam("Accept") String accept
    ...
    throws NotFoundException {
        return delegate.downloadLogs(programId,environmentId,service,name,date,xGwImsOrgId,authorization,xApiKey,accept);
    }
    @GET
    ...
    public Response getBranches(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the repository",required=true) @PathParam("repositoryId") String repositoryId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
)
    throws NotFoundException {
        return delegate.getBranches(programId,repositoryId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "No pipeline execution exits or unknown pipeline or program", response = PipelineExecution.class) })
    public Response getCurrentExecution(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getCurrentExecution(programId,pipelineId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    @Path("/program/{programId}/environment/{environmentId}")
    ...
    public Response getEnvironment(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the environment",required=true) @PathParam("environmentId") String environmentId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getEnvironment(programId,environmentId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "invalid parameters", response = EnvironmentLogs.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Environment not found", response = EnvironmentLogs.class) })
    public Response getEnvironmentLogs(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the environment",required=true) @PathParam("environmentId") String environmentId
,@ApiParam(value = "number of days for which logs are required",required=true) @QueryParam("days") Integer days
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
,@ApiParam(value = "Names of services", defaultValue="new ArrayList<String>()") @DefaultValue("new ArrayList<String>()") @QueryParam("service") List<String> service
,@ApiParam(value = "Names of log", defaultValue="new ArrayList<String>()") @DefaultValue("new ArrayList<String>()") @QueryParam("name") List<String> name
)
    throws NotFoundException {
        return delegate.getEnvironmentLogs(programId,environmentId,days,xGwImsOrgId,authorization,xApiKey,service,name);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Environment not found", response = VariableList.class) })
    public Response getEnvironmentVariables(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the environment",required=true) @PathParam("environmentId") String environmentId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getEnvironmentVariables(programId,environmentId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Program not found", response = EnvironmentList.class) })
    public Response getEnvironments(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
,@ApiParam(value = "Type of the environment", allowableValues="dev, stage, prod") @QueryParam("type") String type
    ...
    throws NotFoundException {
        return delegate.getEnvironments(programId,xGwImsOrgId,authorization,xApiKey,type);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "No pipeline execution exits or unknown pipeline or application", response = PipelineExecution.class) })
    public Response getExecution(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "Identifier of the execution",required=true) @PathParam("executionId") String executionId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getExecution(programId,pipelineId,executionId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 403, message = "Missing permission for user to read executions", response = PipelineExecutionListRepresentation.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Pipeline does not exist", response = PipelineExecutionListRepresentation.class) })
    public Response getExecutions(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
...
,@ApiParam(value = "Pagination limit parameter") @QueryParam("limit") Integer limit
    ...
    throws NotFoundException {
        return delegate.getExecutions(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,start,limit);
    }
    @GET
    @Path("/program/{programId}/pipeline/{pipelineId}")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Pipeline not found", response = Pipeline.class) })
    public Response getPipeline(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getPipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    public Response getPipelines(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
)
    throws NotFoundException {
        return delegate.getPipelines(programId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    @Path("/program/{programId}")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Program not found", response = Program.class) })
    public Response getProgram(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
)
    throws NotFoundException {
        return delegate.getProgram(programId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    @Path("/programs")
...
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getPrograms(xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    public Response getRepositories(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
)
    throws NotFoundException {
        return delegate.getRepositories(programId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    public Response getRepository(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the repository",required=true) @PathParam("repositoryId") String repositoryId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.getRepository(programId,repositoryId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    public Response getStepLogs(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "Identifier of the execution",required=true) @PathParam("executionId") String executionId
,@ApiParam(value = "Identifier of the phase",required=true) @PathParam("phaseId") String phaseId
,@ApiParam(value = "Identifier of the step",required=true) @PathParam("stepId") String stepId
...
,@ApiParam(value = "Specify application/json in this header to receive a JSON response. Otherwise, a 307 response code will be returned with a Location header." )@HeaderParam("Accept") String accept
    ...
    throws NotFoundException {
        return delegate.getStepLogs(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey,file,accept);
    }
    @PATCH
    @Path("/program/{programId}/environment/{environmentId}/variables")
    @Consumes({ "application/json" })
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 404, message = "Environment not found", response = VariableList.class) })
    public Response patchEnvironmentVariables(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the environment",required=true) @PathParam("environmentId") String environmentId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
,@ApiParam(value = "Must always be application/json" ,required=true)@HeaderParam("Content-Type") String contentType
,@ApiParam(value = "The list of variables to add, modify, or remove. It is not necessary to send variables here which are not changing." ,required=true) List<Variable> body
)
    throws NotFoundException {
        return delegate.patchEnvironmentVariables(programId,environmentId,xGwImsOrgId,authorization,xApiKey,contentType,body);
    }
    @PATCH
    @Path("/program/{programId}/pipeline/{pipelineId}")
    @Consumes({ "application/json" })
    ...
    public Response patchPipeline(@ApiParam(value = "Identifier of the program",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
,@ApiParam(value = "Must always be application/json" ,required=true)@HeaderParam("Content-Type") String contentType
,@ApiParam(value = "The updated Pipeline" ,required=true) Pipeline body
)
    throws NotFoundException {
        return delegate.patchPipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,contentType,body);
    }
    @PUT
    @Path("/program/{programId}/pipeline/{pipelineId}/execution")
    ...
    public Response startPipeline(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "IMS organization ID that the request is being made under." ,required=true)@HeaderParam("x-gw-ims-org-id") String xGwImsOrgId
,@ApiParam(value = "Bearer [token] - An access token for the technical account created through integration with Adobe IO" ,required=true)@HeaderParam("Authorization") String authorization
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
,@ApiParam(value = "Must always be application/json" ,required=true)@HeaderParam("Content-Type") String contentType
    ...
    throws NotFoundException {
        return delegate.startPipeline(programId,pipelineId,xGwImsOrgId,authorization,xApiKey,contentType);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 403, message = "Missing permission for user to read metrics", response = PipelineStepMetrics.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Pipeline execution does not exist", response = PipelineStepMetrics.class) })
    public Response stepMetric(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "Identifier of the execution",required=true) @PathParam("executionId") String executionId
,@ApiParam(value = "Identifier of the phase",required=true) @PathParam("phaseId") String phaseId
,@ApiParam(value = "Identifier of the step",required=true) @PathParam("stepId") String stepId
...
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.stepMetric(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey);
    }
    @GET
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 403, message = "Missing permission for user to read step", response = PipelineExecutionStepState.class),
        
        @io.swagger.annotations.ApiResponse(code = 404, message = "Pipeline execution does not exist", response = PipelineExecutionStepState.class) })
    public Response stepState(@ApiParam(value = "Identifier of the program.",required=true) @PathParam("programId") String programId
,@ApiParam(value = "Identifier of the pipeline",required=true) @PathParam("pipelineId") String pipelineId
,@ApiParam(value = "Identifier of the execution",required=true) @PathParam("executionId") String executionId
,@ApiParam(value = "Identifier of the phase",required=true) @PathParam("phaseId") String phaseId
,@ApiParam(value = "Identifier of the step",required=true) @PathParam("stepId") String stepId
...
,@ApiParam(value = "IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io" ,required=true)@HeaderParam("x-api-key") String xApiKey
    ...
    throws NotFoundException {
        return delegate.stepState(programId,pipelineId,executionId,phaseId,stepId,xGwImsOrgId,authorization,xApiKey);
    }
}
