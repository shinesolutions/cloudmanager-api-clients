...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EnvironmentLogLinks : IEquatable<EnvironmentLogLinks>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EnvironmentLogLinks)obj);
        }

        /// <summary>
        /// Returns true if EnvironmentLogLinks instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvironmentLogLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvironmentLogLinks other)
        {
            ...
            return 
                (
                    HttpNsAdobeComAdobecloudRelLogsDownload == other.HttpNsAdobeComAdobecloudRelLogsDownload ||
                    HttpNsAdobeComAdobecloudRelLogsDownload != null &&
                    HttpNsAdobeComAdobecloudRelLogsDownload.Equals(other.HttpNsAdobeComAdobecloudRelLogsDownload)
                ) && 
                (
                    HttpNsAdobeComAdobecloudRelLogsTail == other.HttpNsAdobeComAdobecloudRelLogsTail ||
                    HttpNsAdobeComAdobecloudRelLogsTail != null &&
                    HttpNsAdobeComAdobecloudRelLogsTail.Equals(other.HttpNsAdobeComAdobecloudRelLogsTail)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + HttpNsAdobeComAdobecloudRelLogsDownload.GetHashCode();
                    if (HttpNsAdobeComAdobecloudRelLogsTail != null)
                    hashCode = hashCode * 59 + HttpNsAdobeComAdobecloudRelLogsTail.GetHashCode();
                return hashCode;
            }
        }
