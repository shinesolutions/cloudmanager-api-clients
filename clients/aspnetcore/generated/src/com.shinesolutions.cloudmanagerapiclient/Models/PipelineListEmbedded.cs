...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PipelineListEmbedded : IEquatable<PipelineListEmbedded>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PipelineListEmbedded)obj);
        }

        /// <summary>
        /// Returns true if PipelineListEmbedded instances are equal
        /// </summary>
        /// <param name="other">Instance of PipelineListEmbedded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PipelineListEmbedded other)
        {
            ...
            return 
                (
                    ...
                    Pipelines != null &&
                    other.Pipelines != null &&
                    Pipelines.SequenceEqual(other.Pipelines)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Pipelines != null)
                    hashCode = hashCode * 59 + Pipelines.GetHashCode();
                return hashCode;
            }
        }
