...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PipelineExecutionListRepresentationEmbedded : IEquatable<PipelineExecutionListRepresentationEmbedded>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PipelineExecutionListRepresentationEmbedded)obj);
        }

        /// <summary>
        /// Returns true if PipelineExecutionListRepresentationEmbedded instances are equal
        /// </summary>
        /// <param name="other">Instance of PipelineExecutionListRepresentationEmbedded to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Executions != null)
                    hashCode = hashCode * 59 + Executions.GetHashCode();
                return hashCode;
            }
        }
