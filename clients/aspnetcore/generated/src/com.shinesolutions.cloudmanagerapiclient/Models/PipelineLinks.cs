...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PipelineLinks : IEquatable<PipelineLinks>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PipelineLinks)obj);
        }

        /// <summary>
        /// Returns true if PipelineLinks instances are equal
        /// </summary>
        /// <param name="other">Instance of PipelineLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PipelineLinks other)
        {
            ...
            return 
                ...
                (
                    HttpNsAdobeComAdobecloudRelExecutions == other.HttpNsAdobeComAdobecloudRelExecutions ||
                    HttpNsAdobeComAdobecloudRelExecutions != null &&
                    HttpNsAdobeComAdobecloudRelExecutions.Equals(other.HttpNsAdobeComAdobecloudRelExecutions)
                ) && 
                (
                    HttpNsAdobeComAdobecloudRelRollbackLastSuccessfulExecution == other.HttpNsAdobeComAdobecloudRelRollbackLastSuccessfulExecution ||
                    HttpNsAdobeComAdobecloudRelRollbackLastSuccessfulExecution != null &&
                    HttpNsAdobeComAdobecloudRelRollbackLastSuccessfulExecution.Equals(other.HttpNsAdobeComAdobecloudRelRollbackLastSuccessfulExecution)
                ) && 
                (
                    Self == other.Self ||
                    Self != null &&
