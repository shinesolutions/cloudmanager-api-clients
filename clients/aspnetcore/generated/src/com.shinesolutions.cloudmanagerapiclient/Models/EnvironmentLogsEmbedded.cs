...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EnvironmentLogsEmbedded : IEquatable<EnvironmentLogsEmbedded>
    {
        /// <summary>
        /// Links to logs
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EnvironmentLogsEmbedded)obj);
        }

        /// <summary>
        /// Returns true if EnvironmentLogsEmbedded instances are equal
        /// </summary>
        /// <param name="other">Instance of EnvironmentLogsEmbedded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvironmentLogsEmbedded other)
        {
            ...
            return 
                (
                    ...
                    Downloads != null &&
                    other.Downloads != null &&
                    Downloads.SequenceEqual(other.Downloads)
                );
        }
