...
std::string VariableList__links::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
void VariableList__links::fromJsonString(std::string const& jsonString)
{
...
ptree VariableList__links::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
	if (m_Http__ns_adobe_com_adobecloud_rel_environment != nullptr) {
		pt.add_child("http://ns.adobe.com/adobecloud/rel/environment", m_Http__ns_adobe_com_adobecloud_rel_environment->toPropertyTree());
	}
...
void VariableList__links::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	if (pt.get_child_optional("http://ns.adobe.com/adobecloud/rel/environment")) {
		m_Http__ns_adobe_com_adobecloud_rel_environment = std::make_shared<HalLink>();
		m_Http__ns_adobe_com_adobecloud_rel_environment->fromPropertyTree(pt.get_child("http://ns.adobe.com/adobecloud/rel/environment"));
	}
...
void VariableList__links::setHttpNsAdobeComAdobecloudRelEnvironment(std::shared_ptr<HalLink> value)
{
...
void VariableList__links::setHttpNsAdobeComAdobecloudRelProgram(std::shared_ptr<HalLink> value)
{
...
void VariableList__links::setSelf(std::shared_ptr<HalLink> value)
{
	m_Self = value;
}
