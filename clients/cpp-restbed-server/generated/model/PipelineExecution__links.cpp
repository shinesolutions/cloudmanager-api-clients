...
std::string PipelineExecution__links::toJsonString(bool prettyJson)
{
	std::stringstream ss;
...
void PipelineExecution__links::fromJsonString(std::string const& jsonString)
{
...
ptree PipelineExecution__links::toPropertyTree()
{
	ptree pt;
	ptree tmp_node;
...
void PipelineExecution__links::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
...
void PipelineExecution__links::setHttpNsAdobeComAdobecloudRelProgram(std::shared_ptr<HalLink> value)
{
...
void PipelineExecution__links::setHttpNsAdobeComAdobecloudRelPipeline(std::shared_ptr<HalLink> value)
{
...
void PipelineExecution__links::setSelf(std::shared_ptr<HalLink> value)
{
	m_Self = value;
}
