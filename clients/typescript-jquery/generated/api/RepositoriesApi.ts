...
export class RepositoriesApi {
     ...
     */
    public getRepositories(programId: string, xGwImsOrgId: string, authorization: string, xApiKey: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.RepositoryList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/api/program/{programId}/repositories'.replace('{' + 'programId' + '}', encodeURIComponent(String(programId)));
        ...
        $.ajax(requestOptions).then(
            (data: models.RepositoryList, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     * @param xApiKey IMS Client ID (API Key) which is subscribed to consume services on console.adobe.io
     */
    public getRepository(programId: string, repositoryId: string, xGwImsOrgId: string, authorization: string, xApiKey: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.Repository;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/api/program/{programId}/repository/{repositoryId}'.replace('{' + 'programId' + '}', encodeURIComponent(String(programId))).replace('{' + 'repositoryId' + '}', encodeURIComponent(String(repositoryId)));
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.Repository, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
