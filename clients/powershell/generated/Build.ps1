...
$Manifest = @{
    ...
    Description = 'Org.OpenAPITools - the PowerShell module for Cloud Manager API'

    RootModule = 'Org.OpenAPITools.psm1'
    Guid = '{0744418A-869B-4661-A3EF-92030547807F}' # Has to be static, otherwise each new build will be considered different module
    ...
    #
    # DefaultCommandPrefix = 'BranchesApi'
    # DefaultCommandPrefix = 'EnvironmentsApi'
    # DefaultCommandPrefix = 'PipelineExecutionApi'
    # DefaultCommandPrefix = 'PipelinesApi'
    # DefaultCommandPrefix = 'ProgramsApi'
    # DefaultCommandPrefix = 'RepositoriesApi'
    # DefaultCommandPrefix = 'VariablesApi'
}
