...
export class VariableListLinks {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "httpNsAdobeComAdobecloudRelEnvironment",
            "baseName": "http://ns.adobe.com/adobecloud/rel/environment",
            "type": "HalLink"
        },
        {
    ...
    static getAttributeTypeMap() {
        return VariableListLinks.attributeTypeMap;
    }
}
