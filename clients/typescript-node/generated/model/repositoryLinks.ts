...
export class RepositoryLinks {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "httpNsAdobeComAdobecloudRelBranches",
            "baseName": "http://ns.adobe.com/adobecloud/rel/branches",
            "type": "HalLink"
        },
        {
            "name": "self",
    ...
    static getAttributeTypeMap() {
        return RepositoryLinks.attributeTypeMap;
    }
}
