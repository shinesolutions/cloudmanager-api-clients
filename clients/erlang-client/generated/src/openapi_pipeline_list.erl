-module(openapi_pipeline_list).

-export([encode/1]).

-export_type([openapi_pipeline_list/0]).

-type openapi_pipeline_list() ::
    #{ '_totalNumberOfItems' => integer(),
       '_embedded' => openapi_pipeline_list__embedded:openapi_pipeline_list__embedded(),
