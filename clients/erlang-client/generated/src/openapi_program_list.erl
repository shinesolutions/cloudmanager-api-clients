-module(openapi_program_list).

-export([encode/1]).

-export_type([openapi_program_list/0]).

-type openapi_program_list() ::
    #{ '_totalNumberOfItems' => integer(),
       '_embedded' => openapi_program_list__embedded:openapi_program_list__embedded(),
