...
module Data.PipelineExecutionLinks exposing (PipelineExecutionLinks, decoder, encode, encodeWithTag, toString)
...
type alias PipelineExecutionLinks =
...
decoder : Decoder PipelineExecutionLinks
decoder =
    Decode.succeed PipelineExecutionLinks
...
encode : PipelineExecutionLinks -> Encode.Value
encode =
    Encode.object << encodePairs


encodeWithTag : ( String, String ) -> PipelineExecutionLinks -> Encode.Value
encodeWithTag (tagField, tag) model =
    Encode.object <| encodePairs model ++ [ ( tagField, Encode.string tag ) ]


encodePairs : PipelineExecutionLinks -> List (String, Encode.Value)
encodePairs model =
...
toString : PipelineExecutionLinks -> String
toString =
