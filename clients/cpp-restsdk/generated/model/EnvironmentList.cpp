...
void EnvironmentList::validate()
{
    // TODO: implement validation
}

web::json::value EnvironmentList::toJson() const
{
...
bool EnvironmentList::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t("_embedded")))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<EnvironmentList__embedded> refVal__embedded;
...
void EnvironmentList::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EnvironmentList::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t EnvironmentList::getTotalNumberOfItems() const
{
    return m__totalNumberOfItems;
}

void EnvironmentList::setTotalNumberOfItems(int32_t value)
{
    m__totalNumberOfItems = value;
    m__totalNumberOfItemsIsSet = true;
}

bool EnvironmentList::totalNumberOfItemsIsSet() const
{
    return m__totalNumberOfItemsIsSet;
}

void EnvironmentList::unset_totalNumberOfItems()
{
    m__totalNumberOfItemsIsSet = false;
}
std::shared_ptr<EnvironmentList__embedded> EnvironmentList::getEmbedded() const
{
    return m__embedded;
}

void EnvironmentList::setEmbedded(const std::shared_ptr<EnvironmentList__embedded>& value)
{
    m__embedded = value;
    m__embeddedIsSet = true;
}

bool EnvironmentList::embeddedIsSet() const
{
    return m__embeddedIsSet;
}

void EnvironmentList::unset_embedded()
{
    m__embeddedIsSet = false;
}
std::shared_ptr<ProgramList__links> EnvironmentList::getLinks() const
{
    return m__links;
}

void EnvironmentList::setLinks(const std::shared_ptr<ProgramList__links>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool EnvironmentList::linksIsSet() const
{
    return m__linksIsSet;
}

void EnvironmentList::unset_links()
{
    m__linksIsSet = false;
}
}
