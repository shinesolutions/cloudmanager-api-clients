...
OAIRepositoryList::OAIRepositoryList(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRepositoryList::OAIRepositoryList() {
    this->initializeModel();
}

OAIRepositoryList::~OAIRepositoryList() {}

void OAIRepositoryList::initializeModel() {
...
void OAIRepositoryList::fromJson(QString jsonString) {
...
void OAIRepositoryList::fromJsonObject(QJsonObject json) {
...
QString OAIRepositoryList::asJson() const {
...
QJsonObject OAIRepositoryList::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIRepositoryList::getTotalNumberOfItems() const {
    return _total_number_of_items;
}
void OAIRepositoryList::setTotalNumberOfItems(const qint32 &_total_number_of_items) {
    this->_total_number_of_items = _total_number_of_items;
    this->m__total_number_of_items_isSet = true;
}

OAIRepositoryList__embedded OAIRepositoryList::getEmbedded() const {
    return _embedded;
}
void OAIRepositoryList::setEmbedded(const OAIRepositoryList__embedded &_embedded) {
    this->_embedded = _embedded;
    this->m__embedded_isSet = true;
}

OAIProgramList__links OAIRepositoryList::getLinks() const {
    return _links;
}
void OAIRepositoryList::setLinks(const OAIProgramList__links &_links) {
    this->_links = _links;
    this->m__links_isSet = true;
}

bool OAIRepositoryList::isSet() const {
...
bool OAIRepositoryList::isValid() const {
