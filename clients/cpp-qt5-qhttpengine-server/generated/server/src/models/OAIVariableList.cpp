...
qint32 OAIVariableList::getTotalNumberOfItems() const {
    return _total_number_of_items;
}
void OAIVariableList::setTotalNumberOfItems(const qint32 &_total_number_of_items) {
    this->_total_number_of_items = _total_number_of_items;
    this->m__total_number_of_items_isSet = true;
}

OAIVariableList__embedded OAIVariableList::getEmbedded() const {
    return _embedded;
}
void OAIVariableList::setEmbedded(const OAIVariableList__embedded &_embedded) {
    this->_embedded = _embedded;
    this->m__embedded_isSet = true;
}

OAIVariableList__links OAIVariableList::getLinks() const {
    return _links;
}
void OAIVariableList::setLinks(const OAIVariableList__links &_links) {
    this->_links = _links;
