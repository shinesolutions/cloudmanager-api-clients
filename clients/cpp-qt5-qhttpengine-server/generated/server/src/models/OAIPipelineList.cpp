...
OAIPipelineList::OAIPipelineList(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPipelineList::OAIPipelineList() {
    this->initializeModel();
}

OAIPipelineList::~OAIPipelineList() {}

void OAIPipelineList::initializeModel() {
...
void OAIPipelineList::fromJson(QString jsonString) {
...
void OAIPipelineList::fromJsonObject(QJsonObject json) {
...
QString OAIPipelineList::asJson() const {
...
QJsonObject OAIPipelineList::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPipelineList::getTotalNumberOfItems() const {
    return _total_number_of_items;
}
void OAIPipelineList::setTotalNumberOfItems(const qint32 &_total_number_of_items) {
    this->_total_number_of_items = _total_number_of_items;
    this->m__total_number_of_items_isSet = true;
}

OAIPipelineList__embedded OAIPipelineList::getEmbedded() const {
    return _embedded;
}
void OAIPipelineList::setEmbedded(const OAIPipelineList__embedded &_embedded) {
    this->_embedded = _embedded;
    this->m__embedded_isSet = true;
}

OAIProgramList__links OAIPipelineList::getLinks() const {
    return _links;
}
void OAIPipelineList::setLinks(const OAIProgramList__links &_links) {
    this->_links = _links;
    this->m__links_isSet = true;
}

bool OAIPipelineList::isSet() const {
...
bool OAIPipelineList::isValid() const {
