...
module CloudManager.Core where
...
-- | 
data CloudManagerConfig = CloudManagerConfig
...
-- | display the config
instance P.Show CloudManagerConfig where
  show c =
    T.printf
...
-- | constructs a default CloudManagerConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"cloud-manager/0.1.0.0"@
--
newConfig :: IO CloudManagerConfig
newConfig = do
    logCxt <- initLogContext
    return $ CloudManagerConfig
        { configHost = "https://cloudmanager.adobe.io"
        , configUserAgent = "cloud-manager/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => CloudManagerConfig -> auth -> CloudManagerConfig
addAuthMethod config@CloudManagerConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: CloudManagerConfig -> IO CloudManagerConfig
...
withStderrLogging :: CloudManagerConfig -> IO CloudManagerConfig
...
withNoLogging :: CloudManagerConfig -> CloudManagerConfig
...
data CloudManagerRequest req contentType res accept = CloudManagerRequest
  { rMethod  :: NH.Method   -- ^ Method of CloudManagerRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of CloudManagerRequest
  , rParams   :: Params -- ^ params of CloudManagerRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (CloudManagerRequest req contentType res accept) NH.Method
rMethodL f CloudManagerRequest{..} = (\rMethod -> CloudManagerRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (CloudManagerRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f CloudManagerRequest{..} = (\rUrlPath -> CloudManagerRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (CloudManagerRequest req contentType res accept) Params
rParamsL f CloudManagerRequest{..} = (\rParams -> CloudManagerRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (CloudManagerRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f CloudManagerRequest{..} = (\rAuthTypes -> CloudManagerRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => CloudManagerRequest req contentType res accept -> param -> CloudManagerRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: CloudManagerRequest req contentType res accept -> param -> CloudManagerRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: CloudManagerRequest req contentType res accept -> param -> CloudManagerRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** CloudManagerRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> CloudManagerRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = CloudManagerRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: CloudManagerRequest req contentType res accept -> [NH.Header] -> CloudManagerRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: CloudManagerRequest req contentType res accept -> [NH.HeaderName] -> CloudManagerRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => CloudManagerRequest req contentType res accept -> CloudManagerRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => CloudManagerRequest req contentType res accept -> CloudManagerRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: CloudManagerRequest req contentType res accept -> [NH.QueryItem] -> CloudManagerRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: CloudManagerRequest req contentType res accept -> WH.Form -> CloudManagerRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: CloudManagerRequest req contentType res accept -> NH.Part -> CloudManagerRequest req contentType res accept
...
_setBodyBS :: CloudManagerRequest req contentType res accept -> B.ByteString -> CloudManagerRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: CloudManagerRequest req contentType res accept -> BL.ByteString -> CloudManagerRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => CloudManagerRequest req contentType res accept -> P.Proxy authMethod -> CloudManagerRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: CloudManagerConfig
    -> a
    -> CloudManagerRequest req contentType res accept
    -> IO (CloudManagerRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> CloudManagerConfig
  -> IO (CloudManagerRequest req contentType res accept)
_applyAuthMethods req config@(CloudManagerConfig {configAuthMethods = as}) =
  foldlM go req as
  where
