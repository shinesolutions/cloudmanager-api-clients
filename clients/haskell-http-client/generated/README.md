## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Cloud Manager API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Cloud Manager API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | CloudManager                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | cloud-manager                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | CloudManagerConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | CloudManagerRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| CloudManager.Client    | use the "dispatch" functions to send requests       |
| CloudManager.Core      | core funcions, config and request types             |
| CloudManager.API       | construct api requests                              |
| CloudManager.Model     | describes api models                                |
| CloudManager.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| CloudManager.ModelLens | lenses for model fields                             |
| CloudManager.Logging   | logging functions and utils                         |
