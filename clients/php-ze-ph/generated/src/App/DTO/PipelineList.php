...
class PipelineList
{
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\PipelineListEmbedded::class})
     * @DTA\Validator(name="Dictionary", options={"type":\App\DTO\PipelineListEmbedded::class})
     * @var \App\DTO\PipelineListEmbedded
     */
    public $_embedded;
    /**
