...
export function EnvironmentLogsLinksFromJSON(json: any): EnvironmentLogsLinks {
    return EnvironmentLogsLinksFromJSONTyped(json, false);
}

export function EnvironmentLogsLinksFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentLogsLinks {
...
export function EnvironmentLogsLinksToJSON(value?: EnvironmentLogsLinks | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
